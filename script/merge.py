...
def tsv(fname):
    ...
    for line in f.readlines():
        ...
        note = re.sub('(例目の知人|例目の同僚|例目の家族|例目の濃厚接触者|例目患者の同居家族|例目の友人|例目と接触|例目患者の濃厚接触者|例目患者の同居者|例目が利用していた施設の利用者|例目の関連から検査|例目との関連から検査|例目の同居家族|例目が勤務していた医療機関の職員|例目が勤務していた施設の利用者|例目が勤務していた施設の職員|例目等の関連から検査|例目と同居|例目が勤務していた飲食店の利用者)', '', note)
