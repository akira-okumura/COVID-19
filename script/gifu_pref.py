...
f_all = re.sub('\n10歳\n未満\n(男|女)\t', '10歳未満\t\\1性\t', f_all)
f_all = re.sub('\n１歳\n未満\n(男|女)\t', '1歳未満\t\\1性\t', f_all)
f_all = re.sub('\t(\d{4,5})の濃厚接触者', '\t岐阜県内\\1例目の濃厚接触者', f_all)
f_all = re.sub('\t(\d{4,5})の接触者', '\t岐阜県内\\1例目の接触者', f_all)
f_all = re.sub('\t(\d{4,5})等の濃厚接触者', '\t岐阜県内\\1例目等の濃厚接触者', f_all)
f_all = re.sub('\t(\d{4,5})等の接触者', '\t岐阜県内\\1例目等の接触者', f_all)
