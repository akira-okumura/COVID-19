...
for label_mode in range(1 if debug else 3):
    ...
    dummy_edge('aichi3394', 'aichi3524')
    dummy_edge('aichi3038', 'aichi3390')
    dummy_edge('aichi3289', 'aichi3375')
    dummy_edge('aichi2284', 'aichi2625')
    dummy_edge('aichi2168', 'aichi2550')
    dummy_edge('aichi2601', 'aichi2546')
    dummy_edge('aichi2277', 'aichi2892')
    dummy_edge('aichi2340', 'aichi2921')
    dummy_edge('aichi2461', 'aichi2971')
    dummy_edge('aichi2138', 'aichi3084')
    dummy_edge('aichi2131', 'aichi3112')
    dummy_edge('aichi2806', 'aichi3203')
    dummy_edge('aichi2807', 'aichi3372')
    dummy_edge('aichi2689', 'aichi3375')
    dummy_edge('aichi1539', 'aichi1842')
    dummy_edge('aichi1694', 'aichi1919')
    dummy_edge('aichi1755', 'aichi1941')
    dummy_edge('aichi2142', 'aichi2696')
    dummy_edge('aichi2494', 'aichi2663')
    dummy_edge('aichi2612', 'aichi2809')
    dummy_edge('aichi1725', 'aichi2814')
    dummy_edge('aichi1672', 'aichi2850')
    dummy_edge('aichi1600', 'aichi2974')
    dummy_edge('aichi3100', 'aichi3429')
    dummy_edge('aichi3072', 'aichi3492')
    dummy_edge('aichi3444', 'aichi3517')
    dummy_edge('aichi2934', 'aichi3454')
    dummy_edge('aichi3148', 'aichi3261')
    dummy_edge('aichi1780', 'aichi2862')
    dummy_edge('aichi1028', 'aichi1578')
    dummy_edge('aichi1030', 'aichi1611')
    dummy_edge('aichi1258', 'aichi1560')
    dummy_edge('aichi3269', 'aichi3410')
    dummy_edge('aichi1729', 'aichi2810')
    dummy_edge('aichi2624', 'aichi2715')
    dummy_edge('aichi1511', 'aichi2147')
    dummy_edge('aichi1586', 'aichi1871')
    dummy_edge('aichi1869', 'aichi2026')
    dummy_edge('aichi2354', 'aichi2396')
    dummy_edge('aichi1965', 'aichi2319')
    dummy_edge('aichi1766', 'aichi1897')
    dummy_edge('aichi1765', 'aichi1925')
    dummy_edge('aichi1924', 'aichi2073')
    dummy_edge('aichi1966', 'aichi2033')
    dummy_edge('aichi2490', 'aichi2683')
    dummy_edge('aichi2226', 'aichi2717')
    dummy_edge('aichi2141', 'aichi2282')
    dummy_edge('aichi2550', 'aichi4020')
    dummy_edge('aichi3285', 'aichi3957')
    dummy_edge('aichi3822', 'aichi3939')
    dummy_edge('aichi2691', 'aichi3734')
    dummy_edge('aichi3497', 'aichi3728')
    dummy_edge('aichi1948', 'aichi3244')
    dummy_edge('aichi2567', 'aichi3194')
    dummy_edge('aichi3678', 'aichi3847')
    dummy_edge('aichi3675', 'aichi3801')
    dummy_edge('aichi3688', 'aichi3934')
    dummy_edge('aichi3718', 'aichi4140')
    dummy_edge('aichi3355', 'aichi4123')
    dummy_edge('aichi3557', 'aichi4163')
    dummy_edge('aichi3954', 'aichi4209')
    dummy_edge('aichi3272', 'aichi4130')
    dummy_edge('aichi3407', 'aichi4042')
    dummy_edge('aichi2925', 'aichi3419')
    dummy_edge('aichi2924', 'aichi3103')
    dummy_edge('aichi2878', 'aichi3171')
    ...
    dummy_edge('aichi3388', 'aichi3905')
    dummy_edge('aichi3853', 'aichi3996')
    dummy_edge('aichi3755', 'aichi4018')
    dummy_edge('aichi3440', 'aichi4021')
    dummy_edge('aichi2757', 'aichi4108')
    ...
    dummy_edge('gifu486', 'gifu492')
    dummy_edge('gifu472', 'gifu495')
    
    dummy_edge('gifu390', 'gifu468')
    dummy_edge('gifu421', 'gifu498')
    dummy_edge('gifu421', 'gifu510')
    dummy_edge('gifu486', 'gifu506')
    dummy_edge('aichi1221', 'gifu434')
    dummy_edge('gifu486', 'gifu532')
    dummy_edge('aichi3886', 'gifu521')
    dummy_edge('gifu515', 'gifu516')
    dummy_edges(('aichi3950', 'gifu525', 'gifu524','gifu526','gifu530'))
